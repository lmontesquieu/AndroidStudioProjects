...
/**
 * Created by Pepe on 5/18/2016.
 */
public class StudentsProvider extends ContentProvider{

    static final String PROVIDER_NAME = "com.example.pepe.Escuela";
    ...
    static{
        ...
        myUriMatcher.addURI(PROVIDER_NAME,"students",STUDENTS);
        myUriMatcher.addURI(PROVIDER_NAME,"students/#",STUDENTS_ID);
    }
    ...
    static final String DATABASE_NAME = "Escuela";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        /**
         * Register to watch a contentURI for changes
         */
